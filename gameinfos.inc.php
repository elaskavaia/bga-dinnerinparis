...
$gameinfos = [
	...
	'game_name'                            => "Dinner In Paris",
	
	// Game publisher (use empty string if there is no publisher)
	'publisher'                            => 'Funnyfox',
	
	// Url of game publisher website
	'publisher_website'                    => 'https://funnyfox.fr/',
	
	// Board Game Geek ID of the publisher
	'publisher_bgg_id'                     => 42616,
	
	// Board game geek ID of the game
	'bgg_id'                               => 320819,
	
	// Players configuration that can be played (ex: 2 to 4 players)
	//	'players'                              => [1, 2, 3, 4],// Development
	'players'                              => [2, 3, 4],// Prod
	
	// Suggest players to play with this number of players. Must be null if there is no such advice, or if there is only one possible player configuration.
	// NB: the automatic lobby will try first the lowest number of players if this is not specified. So you _have to_ specify this parameter if the lowest player number is not compatible with the default options.
	//	'suggest_player_number'                => 1,// Development
	'suggest_player_number'                => null,// Prod
	...
	'losers_not_ranked'                    => true,// One winner, the others are losers
	...
	//	'language_dependency'                  => ['en', 'fr'],
	
	
	// Colors attributed to players - https://en.doc.boardgamearena.com/Game_meta-information:_gameinfos.inc.php#Colors
	'player_colors'                        => ["ff0000", "00008B", "ff8c00", "00ced1"],
